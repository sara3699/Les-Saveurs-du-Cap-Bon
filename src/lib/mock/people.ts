...
export const CONVERSATION_ATTRIBUTIONS: SourceAttribution[] = [
  ...
  { id: "at_c02", channelId: "instagram", connectionId: "cn_instagram", externalId: "ig_msg_178394021", receivedAt: minutesAgo(24), campaign: null, referrer: "Réponse à une story", conversationId: "cv_02", contactId: "ct_yosr" },
  ...
  { id: "at_c13", channelId: "website", connectionId: "cn_website_form", externalId: "form_51ccd9", receivedAt: daysAgo(4), campaign: null, referrer: "Page plateau de fête Les Saveurs", conversationId: "cv_13", contactId: "ct_karim" },
  ...
  { id: "at_c15", channelId: "instagram", connectionId: "cn_instagram", externalId: "ig_msg_178388120", receivedAt: daysAgo(12), campaign: null, referrer: "Réponse à une story", conversationId: "cv_15", contactId: "ct_mehdi" },
...
export const CONTACTS: Contact[] = [
  {
    ...
    firstContactAt: daysAgo(26), stage: "qualified", tags: ["Client fidèle", "Client prioritaire", "Coffret cadeau"],
    leadScore: 78,
    leadScoreReasons: [
      "Elle a déjà acheté deux fois, en juin et en août",
      "Elle a répondu en moins d'une heure à ses trois derniers messages",
      "Elle a demandé un produit précis au lieu de regarder au hasard",
    ],
    lifetimeValue: 560, ownerId: "tm_sarra",
    notes: [
      { id: "nt_01", authorId: "tm_sarra", createdAt: minutesAgo(31), body: "A acheté le pot saisonnier en juin et a aussi demandé le coffret de desserts. Cela vaut la peine de proposer un prix pour les deux." },
    ],
  },
  {
    id: "ct_slim", name: "Slim Ayari", phone: "+216 98 220 145", email: "slim.ayari@outlook.com",
    city: "Sousse", language: "français", firstTouchChannel: "website", latestTouchChannel: "website",
    firstContactAt: hoursAgo(1), stage: "contacted", tags: ["Question livraison"],
    leadScore: 54,
    leadScoreReasons: ["Premier message arrivé aujourd'hui", "Il a donné une date de livraison à respecter"],
  ...
  },
  {
    ...
    firstContactAt: daysAgo(19), stage: "proposal", tags: ["Coffret cadeau", "Client fidèle"],
    leadScore: 66,
    leadScoreReasons: [
      "Elle a trouvé la boutique sur Instagram puis est passée d'elle-même sur WhatsApp",
      "Elle a une commande en cours de plus de 400 dinars",
    ],
    lifetimeValue: 412, ownerId: "tm_khaled",
    notes: [
      { id: "nt_02", authorId: "tm_khaled", createdAt: daysAgo(1), body: "Arrivée par Instagram au départ. Elle préfère les messages vocaux sur WhatsApp." },
    ],
  },
  {
    id: "ct_amine", name: "Amine Bouzid", phone: "+216 74 310 220", email: "a.bouzid@sfaxnet.tn",
    city: "Sfax", language: "français", firstTouchChannel: "google", latestTouchChannel: "google",
    firstContactAt: hoursAgo(3), stage: "new", tags: ["Question prix"],
    leadScore: 41,
    leadScoreReasons: ["Il vient d'une annonce payante, son intention reste à confirmer", "Aucune réponse depuis l'envoi du formulaire"],
    lifetimeValue: 0, ownerId: null, notes: [],
  },
  {
    id: "ct_nadia", name: "Nadia Chaabane", phone: "+216 22 447 019", email: "nadia.chaabane@gmail.com",
    city: "La Marsa", language: "français", firstTouchChannel: "facebook", latestTouchChannel: "facebook",
    firstContactAt: daysAgo(34), stage: "won", tags: ["Client fidèle"],
    leadScore: 82,
    leadScoreReasons: ["Trois commandes terminées", "Elle n'a jamais demandé de retour"],
  ...
  },
  {
    ...
    leadScore: 60,
    leadScoreReasons: ["Elle commande par téléphone toutes les deux ou trois semaines", "Plus grosse commande des données d'exemple"],
    lifetimeValue: 2080, ownerId: "tm_sarra", notes: [],
  },
  {
    id: "ct_mehdi", name: "Mehdi Karoui", phone: "+216 92 663 118", email: "mehdi.karoui@gmail.com",
    city: "Bizerte", language: "français", firstTouchChannel: "website", latestTouchChannel: "instagram",
    firstContactAt: daysAgo(22), stage: "qualified", tags: ["Vente en gros"],
    leadScore: 58,
    leadScoreReasons: ["Il a demandé le prix pour douze pièces à la fois", "Il est arrivé par le site et écrit maintenant sur Instagram"],
  ...
  },
  {
    ...
    city: "Monastir", language: "français", firstTouchChannel: "google", latestTouchChannel: "website",
    ...
    leadScoreReasons: [
      ...
      "Elle a demandé un devis pour huit coffrets cadeaux",
    ],
  ...
  },
  {
    ...
    leadScore: 22,
    leadScoreReasons: ["Il a dit que le prix dépassait son budget", "Aucune réponse depuis huit jours"],
  ...
  },
  {
    ...
    firstContactAt: daysAgo(48), stage: "contacted", tags: ["Client fidèle", "Gamme Ramadan"],
    leadScore: 49,
    leadScoreReasons: ["Elle a été ajoutée à la main après un appel", "Deux commandes depuis, les deux sur WhatsApp"],
   ...
   */
  {
    ...
    leadScore: 30,
    leadScoreReasons: ["Ajoutée par un import de tableur le 6 septembre 2026", "Aucune conversation sur cette fiche"],
    lifetimeValue: 0, ownerId: null, notes: [],
  },
  {
    id: "ct_leila_dup", name: "L. Ferchichi", phone: null, email: "leila.ferchichi@gmail.com",
    city: "Monastir", language: "français", firstTouchChannel: "website", latestTouchChannel: "website",
    firstContactAt: daysAgo(3), stage: "new", tags: [],
    leadScore: 28,
    leadScoreReasons: ["Ajoutée par un import de tableur le 6 septembre 2026", "Aucune conversation sur cette fiche"],
    lifetimeValue: 0, ownerId: null, notes: [],
  },
  {
    ...
    city: "Tunis", language: "français", firstTouchChannel: "website", latestTouchChannel: "website",
    firstContactAt: daysAgo(4), stage: "new", tags: ["Question prix"],
    leadScore: 44,
    leadScoreReasons: ["Il a consulté la page du plateau de desserts avant d'écrire", "Aucune réponse de notre part depuis quatre jours"],
    lifetimeValue: 0, ownerId: null, notes: [],
  },
];

export const CONVERSATIONS: Conversation[] = [
  { id: "cv_01", contactId: "ct_rania", attributionId: "at_c01", subject: "Crème de pistache en stock", status: "open", priority: true, unreadCount: 2, assigneeId: "tm_sarra", tags: ["Client prioritaire"], lastMessageAt: minutesAgo(9) },
  { id: "cv_02", contactId: "ct_yosr", attributionId: "at_c02", subject: "Photo du dessert à la pistache", status: "waiting", priority: false, unreadCount: 0, assigneeId: "tm_khaled", tags: ["Coffret cadeau"], lastMessageAt: minutesAgo(24) },
  { id: "cv_03", contactId: "ct_slim", attributionId: "at_c03", subject: "Livraison à Sousse avant vendredi", status: "new", priority: false, unreadCount: 1, assigneeId: "tm_mouna", tags: ["Question livraison"], lastMessageAt: hoursAgo(1) },
  ...
  { id: "cv_06", contactId: "ct_olfa", attributionId: "at_c06", subject: "Prix de la livraison à Nabeul", status: "open", priority: false, unreadCount: 1, assigneeId: "tm_mouna", tags: ["Question livraison"], lastMessageAt: hoursAgo(5) },
  ...
  { id: "cv_09", contactId: "ct_hatem", attributionId: "at_c09", subject: "Combien coûte l'assortiment de desserts", status: "new", priority: false, unreadCount: 1, assigneeId: null, tags: ["Question prix"], lastMessageAt: daysAgo(2) },
  ...
  { id: "cv_12", contactId: "ct_walid", attributionId: "at_c12", subject: "Dessert à la pistache, y a-t-il une remise", status: "snoozed", priority: false, unreadCount: 0, assigneeId: "tm_yassine", tags: ["Question prix"], lastMessageAt: daysAgo(8) },
  ...
  { id: "cv_14", contactId: "ct_rania", attributionId: "at_c14", subject: "Pot saisonnier livré", status: "resolved", priority: false, unreadCount: 0, assigneeId: "tm_sarra", tags: [], lastMessageAt: daysAgo(5) },
  ...
  { id: "cv_17", contactId: "ct_leila", attributionId: "at_c17", subject: "Livrez-vous à Monastir", status: "resolved", priority: false, unreadCount: 0, assigneeId: "tm_mouna", tags: ["Question livraison"], lastMessageAt: daysAgo(9) },
...
export const MESSAGES: Message[] = [
  { id: "ms_0101", conversationId: "cv_01", direction: "inbound", body: "Bonjour, est-ce que la crème de pistache est toujours disponible ?", sentAt: minutesAgo(38), authorId: null, externalId: "wamid.HBgLMjE2MjAxMTQ4ODIVAgAR", attachments: [] },
  ...
  { id: "ms_0103", conversationId: "cv_01", direction: "outbound", body: "Bonjour Rania. Oui, la verte est en stock. La livraison à Ariana prend deux jours, samedi est donc possible.", sentAt: minutesAgo(33), authorId: "tm_sarra", externalId: "wamid.HBgLMjE2MjAxMTQ4ODIVAgAT", attachments: [] },
  { id: "ms_0104", conversationId: "cv_01", direction: "note", body: "Elle a acheté le pot saisonnier en juin et a aussi demandé le coffret de desserts. Cela vaut la peine de proposer un prix pour les deux.", sentAt: minutesAgo(31), authorId: "tm_sarra", externalId: null, attachments: [] },
  ...
  { id: "ms_0201", conversationId: "cv_02", direction: "inbound", body: "C'est le dessert à la pistache dont je parlais, celui de votre story.", sentAt: hoursAgo(3), authorId: null, externalId: "ig_msg_178394021", attachments: [{ id: "at_img_02", kind: "image", filename: "story-screenshot.jpg", sizeLabel: "612 KB" }] },
  { id: "ms_0202", conversationId: "cv_02", direction: "outbound", body: "C'est le dessert à la pistache, 68 TND dans le catalogue d'exemple. Je peux vous en mettre un de côté.", sentAt: hoursAgo(2), authorId: "tm_khaled", externalId: "ig_msg_178394044", attachments: [] },
  { id: "ms_0203", conversationId: "cv_02", direction: "inbound", body: "Je vais y réfléchir ce soir.", sentAt: minutesAgo(24), authorId: null, externalId: "ig_msg_178394090", attachments: [] },

  { id: "ms_0301", conversationId: "cv_03", direction: "inbound", body: "Bonjour, je voudrais commander deux assortiments de desserts. Livraison possible à Sousse avant vendredi ?", sentAt: hoursAgo(1), authorId: null, externalId: "form_7d31c0", attachments: [] },
  ...
  { id: "ms_0502", conversationId: "cv_05", direction: "outbound", body: "Merci Nadia, à bientôt.", sentAt: daysAgo(1), authorId: "tm_yassine", externalId: "mid.$cAAB1x9m", attachments: [] },

  { id: "ms_0601", conversationId: "cv_06", direction: "inbound", body: "Combien la livraison à Nabeul ?", sentAt: hoursAgo(6), authorId: null, externalId: "wamid.HBgLMjE2OTgyMjExMD", attachments: [] },
  { id: "ms_0602", conversationId: "cv_06", direction: "outbound", body: "7,500 TND, et c'est gratuit au-delà de 200 TND.", sentAt: hoursAgo(6), authorId: "tm_mouna", externalId: "wamid.HBgLMjE2OTgyMjExME", attachments: [] },
  { id: "ms_0603", conversationId: "cv_06", direction: "inbound", body: "D'accord, je prépare ma liste.", sentAt: hoursAgo(5), authorId: null, externalId: "wamid.HBgLMjE2OTgyMjExMF", attachments: [] },

  { id: "ms_0701", conversationId: "cv_07", direction: "inbound", body: "Je gère un petit hôtel à Bizerte. Quel est le prix pour douze assortiments de desserts ?", sentAt: hoursAgo(8), authorId: null, externalId: "form_9a02be", attachments: [] },
  { id: "ms_0702", conversationId: "cv_07", direction: "outbound", body: "Pour douze, je peux faire 70 TND pièce dans le catalogue d'exemple au lieu de 78. Livraison comprise.", sentAt: hoursAgo(7), authorId: "tm_khaled", externalId: null, attachments: [] },
  { id: "ms_0703", conversationId: "cv_07", direction: "note", body: "Il a d'abord écrit par le site, puis est passé sur Instagram en août. Même personne, même numéro.", sentAt: hoursAgo(7), authorId: "tm_khaled", externalId: null, attachments: [] },

  { id: "ms_0801", conversationId: "cv_08", direction: "note", body: "Elle est passée à la boutique de Nabeul et a repris sa commande habituelle. Saisie à la main au comptoir.", sentAt: hoursAgo(6), authorId: "tm_sarra", externalId: null, attachments: [] },
  ...
  { id: "ms_1002", conversationId: "cv_10", direction: "outbound", body: "Oui. Pour huit coffrets, 940 TND l'unité au lieu de 1 040. Je vous envoie le devis aujourd'hui.", sentAt: daysAgo(2), authorId: "tm_khaled", externalId: null, attachments: [] },
  { id: "ms_1003", conversationId: "cv_10", direction: "note", body: "Elle est arrivée par une annonce Google en août, puis est revenue d'elle-même par le site. Le premier contact reste Google.", sentAt: daysAgo(2), authorId: "tm_khaled", externalId: null, attachments: [] },

  { id: "ms_1101", conversationId: "cv_11", direction: "outbound", body: "Les assortiments de desserts sont de retour en stock, comme vous l'aviez demandé.", sentAt: daysAgo(3), authorId: "tm_mouna", externalId: "wamid.HBgLMjE2NTUxMjM0NT", attachments: [] },
  { id: "ms_1102", conversationId: "cv_11", direction: "inbound", body: "Très bien, je passe samedi.", sentAt: daysAgo(3), authorId: null, externalId: "wamid.HBgLMjE2NTUxMjM0NU", attachments: [] },
  ...
  { id: "ms_1202", conversationId: "cv_12", direction: "outbound", body: "Le prix du dessert à la pistache est fixe dans le catalogue d'exemple. Je peux offrir la livraison.", sentAt: daysAgo(8), authorId: "tm_yassine", externalId: "mid.$cAAB1w7Sa", attachments: [] },
  { id: "ms_1203", conversationId: "cv_12", direction: "note", body: "Reporté d'une semaine. S'il ne répond pas, marquez le prospect comme perdu.", sentAt: daysAgo(8), authorId: "tm_yassine", externalId: null, attachments: [] },
  ...
  { id: "ms_1401", conversationId: "cv_14", direction: "inbound", body: "Le pot saisonnier est bien arrivé, merci.", sentAt: daysAgo(5), authorId: null, externalId: "wamid.HBgLMjE2MjAxMTQ4ODJ2", attachments: [] },
  { id: "ms_1402", conversationId: "cv_14", direction: "outbound", body: "Content qu'il soit arrivé en bon état, Rania.", sentAt: daysAgo(5), authorId: "tm_sarra", externalId: "wamid.HBgLMjE2MjAxMTQ4ODJ3", attachments: [] },

  { id: "ms_1501", conversationId: "cv_15", direction: "inbound", body: "Les coffrets de desserts sont-ils préparés à la main ?", sentAt: daysAgo(12), authorId: null, externalId: "ig_msg_178388120", attachments: [] },
  { id: "ms_1502", conversationId: "cv_15", direction: "outbound", body: "Ils sont préparés à la main. Deux coffrets de fête ne sont jamais exactement identiques.", sentAt: daysAgo(12), authorId: "tm_khaled", externalId: "ig_msg_178388133", attachments: [] },

  { id: "ms_1601", conversationId: "cv_16", direction: "inbound", body: "Pouvez-vous livrer à mon bureau plutôt ? Rue de Marseille, Tunis.", sentAt: daysAgo(6), authorId: null, externalId: "wamid.HBgLMjE2OTQ0MTIzMT", attachments: [] },
  { id: "ms_1602", conversationId: "cv_16", direction: "outbound", body: "Adresse modifiée, le livreur a la nouvelle.", sentAt: daysAgo(6), authorId: "tm_khaled", externalId: "wamid.HBgLMjE2OTQ0MTIzMU", attachments: [] },

  { id: "ms_1701", conversationId: "cv_17", direction: "inbound", body: "Est-ce que vous livrez à Monastir ?", sentAt: daysAgo(9), authorId: null, externalId: "form_2bb47f", attachments: [] },

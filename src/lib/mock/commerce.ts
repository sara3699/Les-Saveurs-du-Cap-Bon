...
export const FEATURED_ORDER_ATTRIBUTIONS: SourceAttribution[] = [
  { id: "at_o01", channelId: "manual", connectionId: null, externalId: null, receivedAt: hoursAgo(6), campaign: null, referrer: "Passage en boutique, Nabeul", conversationId: "cv_08", contactId: "ct_ines" },
  { id: "at_o02", channelId: "google", connectionId: "cn_google_ads", externalId: "gads_order_44120", receivedAt: daysAgo(3), campaign: "Coffrets cadeaux, septembre", referrer: null, conversationId: null, contactId: "ct_amine" },
  ...
  { id: "at_o04", channelId: "website", connectionId: "cn_website_form", externalId: "form_ord_7781", receivedAt: daysAgo(2), campaign: null, referrer: "Page de paiement Les Saveurs", conversationId: null, contactId: "ct_karim" },
  ...
  { id: "at_o06", channelId: "instagram", connectionId: "cn_instagram", externalId: "ig_ord_55120", receivedAt: daysAgo(13), campaign: null, referrer: "Réponse a une story", conversationId: "cv_15", contactId: "ct_mehdi" },
  ...
  { id: "at_o09", channelId: "website", connectionId: "cn_website_form", externalId: "form_ord_7802", receivedAt: hoursAgo(4), campaign: null, referrer: "Page de paiement Les Saveurs", conversationId: null, contactId: "ct_olfa" },
  { id: "at_o10", channelId: "instagram", connectionId: "cn_instagram", externalId: "ig_ord_55208", receivedAt: daysAgo(4), campaign: null, referrer: "Commentaire sous une publication", conversationId: null, contactId: "ct_yosr" },
  { id: "at_o11", channelId: "manual", connectionId: null, externalId: null, receivedAt: daysAgo(15), campaign: null, referrer: "Commande par téléphone", conversationId: null, contactId: "ct_ines" },
...
const FEATURED: Omit<Order, "total">[] = [
  ...
  { id: "or_04", reference: "ORD-2479", contactId: "ct_karim", attributionId: "at_o04", conversationId: null, placedAt: daysAgo(2), paymentStatus: "cash_on_delivery", deliveryStatus: "dispatched", assigneeId: "tm_mouna", items: [item("pr_dairy_sélection", 1)], deliveryFee: 0 },
  ...
  { id: "or_07", reference: "ORD-2473", contactId: "ct_yosr", attributionId: "at_o07", conversationId: "cv_16", placedAt: daysAgo(6), paymentStatus: "paid", deliveryStatus: "delivered", assigneeId: "tm_khaled", items: [item("pr_dairy_sélection", 1)], deliveryFee: 0 },
...
const CAMPAIGNS = ["Coffrets cadeaux, septembre", "Marque, en continu", "Reciblage, panier"];
const REFERRERS = [
  "Page de paiement Les Saveurs",
  "Page produit Les Saveurs",
  "Page assortiment Les Saveurs",
];
...
function generateHistory(): { orders: Order[]; attributions: SourceAttribution[] } {
  ...
  for (let day = 74; day >= 0; day--) {
    ...
    for (let n = 0; n < count; n++) {
      ...
      référence += 1;
      const attributionId = `at_g${référence}`;
      attributions.push({
        id: attributionId,
        channelId,
        connectionId: PRIMARY_CONNECTION[channelId] ?? null,
        externalId: channelId === "manual" ? null : `${channelId}_evt_${référence}`,
        receivedAt: placedAt,
...
export const TASKS: Task[] = [
  { id: "tk_01", title: "Garder le pot vert pour Rania jusqu'à jeudi", type: "reminder", contactId: "ct_rania", conversationId: "cv_01", assigneeId: "tm_sarra", dueAt: hoursAhead(5), priority: "high", completedAt: null },
  { id: "tk_02", title: "Envoyer a Rania le prix des deux produits a la pistache", type: "quote", contactId: "ct_rania", conversationId: "cv_01", assigneeId: "tm_sarra", dueAt: hoursAhead(2), priority: "normal", completedAt: null },
  { id: "tk_03", title: "Appeler Slim au sujet de la livraison du vendredi a Sousse", type: "call", contactId: "ct_slim", conversationId: "cv_03", assigneeId: "tm_mouna", dueAt: hoursAgo(2), priority: "high", completedAt: null },
  { id: "tk_04", title: "Répondre a Amine au sujet du prix du coffret cadeau", type: "reply", contactId: "ct_amine", conversationId: "cv_04", assigneeId: "tm_yassine", dueAt: hoursAgo(9), priority: "normal", completedAt: null },
  { id: "tk_05", title: "Envoyer a Leila le devis pour huit coffrets cadeaux", type: "quote", contactId: "ct_leila", conversationId: "cv_10", assigneeId: "tm_khaled", dueAt: daysAgo(1), priority: "high", completedAt: null },
  { id: "tk_06", title: "Répondre a Hatem sur Instagram", type: "reply", contactId: "ct_hatem", conversationId: "cv_09", assigneeId: "tm_mouna", dueAt: hoursAhead(20), priority: "normal", completedAt: null },
  { id: "tk_07", title: "Confirmer a Karim la taille du plateau de desserts", type: "custom", contactId: "ct_karim", conversationId: "cv_13", assigneeId: "tm_mouna", dueAt: daysAhead(1), priority: "low", completedAt: null },
  { id: "tk_08", title: "Rencontrer l'acheteur de l'hotel a Bizerte", type: "meeting", contactId: "ct_mehdi", conversationId: "cv_07", assigneeId: "tm_khaled", dueAt: daysAhead(2), priority: "normal", completedAt: null },
  { id: "tk_09", title: "Relancer Walid avant de clore le prospect", type: "call", contactId: "ct_walid", conversationId: "cv_12", assigneeId: "tm_yassine", dueAt: daysAhead(3), priority: "low", completedAt: null },
  { id: "tk_10", title: "Confirmer le retrait de Sonia samedi", type: "reminder", contactId: "ct_sonia", conversationId: "cv_11", assigneeId: "tm_mouna", dueAt: daysAgo(2), priority: "normal", completedAt: daysAgo(2) },
  { id: "tk_11", title: "Envoyer a Nadia le mot de remerciement", type: "reply", contactId: "ct_nadia", conversationId: "cv_05", assigneeId: "tm_yassine", dueAt: daysAgo(1), priority: "low", completedAt: daysAgo(1) },
  { id: "tk_12", title: "Reapprovisionner les assortiments decouverte", type: "custom", contactId: null, conversationId: null, assigneeId: "tm_sarra", dueAt: minutesAgo(90), priority: "high", completedAt: null },
];

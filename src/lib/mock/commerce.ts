...
export const FEATURED_ORDER_ATTRIBUTIONS: SourceAttribution[] = [
  ...
  { id: "at_o06", channelId: "instagram", connectionId: "cn_instagram", externalId: "ig_ord_55120", receivedAt: daysAgo(13), campaign: null, referrer: "Réponse à une story", conversationId: "cv_15", contactId: "ct_mehdi" },
...
export const TASKS: Task[] = [
  ...
  { id: "tk_02", title: "Envoyer à Rania le prix des deux produits à la pistache", type: "quote", contactId: "ct_rania", conversationId: "cv_01", assigneeId: "tm_sarra", dueAt: hoursAhead(2), priority: "normal", completedAt: null },
  { id: "tk_03", title: "Appeler Slim au sujet de la livraison du vendredi à Sousse", type: "call", contactId: "ct_slim", conversationId: "cv_03", assigneeId: "tm_mouna", dueAt: hoursAgo(2), priority: "high", completedAt: null },
  { id: "tk_04", title: "Répondre à Amine au sujet du prix du coffret cadeau", type: "reply", contactId: "ct_amine", conversationId: "cv_04", assigneeId: "tm_yassine", dueAt: hoursAgo(9), priority: "normal", completedAt: null },
  { id: "tk_05", title: "Envoyer à Leila le devis pour huit coffrets cadeaux", type: "quote", contactId: "ct_leila", conversationId: "cv_10", assigneeId: "tm_khaled", dueAt: daysAgo(1), priority: "high", completedAt: null },
  { id: "tk_06", title: "Répondre à Hatem sur Instagram", type: "reply", contactId: "ct_hatem", conversationId: "cv_09", assigneeId: "tm_mouna", dueAt: hoursAhead(20), priority: "normal", completedAt: null },
  { id: "tk_07", title: "Confirmer à Karim la taille du plateau de desserts", type: "custom", contactId: "ct_karim", conversationId: "cv_13", assigneeId: "tm_mouna", dueAt: daysAhead(1), priority: "low", completedAt: null },
  { id: "tk_08", title: "Rencontrer l'acheteur de l'hôtel à Bizerte", type: "meeting", contactId: "ct_mehdi", conversationId: "cv_07", assigneeId: "tm_khaled", dueAt: daysAhead(2), priority: "normal", completedAt: null },
  ...
  { id: "tk_12", title: "Réapprovisionner les assortiments découverte", type: "custom", contactId: null, conversationId: null, assigneeId: "tm_sarra", dueAt: minutesAgo(90), priority: "high", completedAt: null },
];

...
export const CONNECTIONS: ChannelConnection[] = [
  ...
  },
  {
    ...
    lastErrorMessage: "L'autorisation de la page a été retirée. Depuis, les messages envoyés ne sont pas arrivés.",
  ...
  },
  {
    ...
    summary:
      "Les commandes et les demandes qui arrivent par votre fiche Google Business. Tenue à part de Google Ads, pour qu'un avis ne soit jamais compté comme une commande.",
    ...
    lastErrorAt: null,
    lastErrorMessage: null,
    outstanding: ["Prévu pour une version ultérieure"],
    reviewNote: null,
    eventsThisWeek: 0,
  ...
  },
  {
    ...
    status: "not_connected",
    summary:
      "Transforme les commandes envoyées par e-mail à l'adresse de la boutique en vraies commandes. Un connecteur distinct de Google Ads et de votre fiche Business.",
